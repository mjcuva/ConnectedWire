# Django settings for ConnectedWire project
...
STATICFILES_DIRS = (
    ...
    #'/Users/Marc/Desktop/ConnectedWire/blog/static/'
)
...
SECRET_KEY = '6^jc=lxt#m@*3a3g665im+y4_=^n7ayv(y_k+r1sifc+=0)+0_'
...
ROOT_URLCONF = 'ConnectedWire.urls'
